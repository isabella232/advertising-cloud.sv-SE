...
>[!NOTE]
>
>Du kan även hämta rapporter om avanmälan från försäljning för konsumenter med Advertising Cloud [!DNL Trafficking API]. Instruktioner finns i dokumentationen för [!DNL Trafficking API]. Om din organisation inte använder [!DNL Trafficking API] men är intresserad av mer information kan du kontakta din kontoansvarige på Adobe.
