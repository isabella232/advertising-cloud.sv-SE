---
title: Ange placeringar och annonser för ett avtal-ID
...
# Ange placeringar och annonser för ett avtal-ID
...
För programmatiska erbjudanden (PG) kan du skapa nya placeringar med angivna annonser från [!UICONTROL Deals] vy.
...
1. Klicka på  ![Alternativ-menyn](/help/dsp/assets/options-menu.png) **>[!UICONTROL attach a placement]**.
