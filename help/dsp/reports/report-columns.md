...
| [!UICONTROL Dimension] | [!UICONTROL Date/Time] | Dag [!UICONTROL of Week] | Den specifika dagen, som [!UICONTROL Monday] eller [!UICONTROL Tuesday]. |
...
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Browser] | Webbläsaren där annonsen visades (till exempel [!UICONTROL Chrome] eller [!UICONTROL Firefox]). |
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Environment] | Om annonsen visades på *[!UICONTROL sites]* eller *[!UICONTROL Apps]*. |
...
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Manufacturer] | Tillverkaren av den enhet på vilken annonsen visades (t.ex. [!UICONTROL Samsung], [!UICONTROL Lenovo], eller [!UICONTROL Apple]). |
...
| [!UICONTROL Dimension] | [!UICONTROL Placement] | [!UICONTROL Device Environment] | De enhetsmiljöer som placeringen har som mål: (*[!UICONTROL Desktop]*, *[!UICONTROL Mobile]* och/eller *[!UICONTROL Connected TV])*. |
...
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL % Distinct Uniques] | The [!UICONTROL App/Site Distinct Uniques] dividerat med [!UICONTROL App/Site Uniques]. |
...
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Cost per Distinct Unique] | The [!UICONTROL Total Spend] dividerat med [!UICONTROL App/Site Distinct Uniques]. |
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Cost per Unique] | The [!UICONTROL Total Spend] dividerat med [!UICONTROL App/Site Uniques]. |
...
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Average Frequency] | Genomsnittligt antal visningar som visas för unika. För en del lager skickas ingen enhets-ID och dessa visningar inkluderas inte i det här värdet. Det finns ett liknande mått i [!UICONTROL Frequency (by App/Site)] men det måttet är inte uppskattat. |
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Impressions (Device/Browser)] | (Ingår i [!UICONTROL Frequency (by Impression)] rapport) Uppskattat intryck för en viss frekvensfördelning. Advertising Cloud skattningar bygger på ett urval av visningar. För en del lager skickas ingen enhets-ID och dessa visningar inkluderas inte i det här värdet. Det finns ett liknande mått i [!UICONTROL Frequency (by App/Site)] men det måttet är inte uppskattat. |
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Uniques (Device/Browser)] | (Ingår i [!UICONTROL Frequency (by Impression)] rapport) Antalet unika webbläsare eller enheter som registreras för en viss frekvens. Advertising Cloud skattningar bygger på ett urval av visningar. För en del lager ska du inte skicka med en enhetsidentifierare, och dessa visningar inkluderas inte i det här värdet. Det finns ett liknande mått i [!UICONTROL Frequency (by App/Site)] men det måttet är inte uppskattat. |
...
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPA] | Genomsnittlig bruttokostnad per förvärv, beräknad med [!UICONTROL Gross Spend] / [!UICONTROL Custom Goal]. |
...
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPM] | Genomsnittskostnaden per 1 000 visningar, beräknad med [!UICONTROL Gross Spend] / [!UICONTROL Impressions] x 1000. |
...
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross vCPM] | Genomsnittskostnaden per 1 000 visningar, beräknad med [!UICONTROL Gross Spend] / [!UICONTROL Viewable Impressions] x 1000. |
...
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPM] | Genomsnittlig nettokostnad per 1 000 visningar, beräknad med [!UICONTROL Net Spend] / [!UICONTROL Impressions] x 1000. |
...
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Total Data eCPM] | Den genomsnittliga nettodatakostnaden per 1 000 visningar, beräknad med [!UICONTROL Net Spend (Data)] / [!UICONTROL Impressions] x 1000. |
...
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Margin %] | (När marginalhantering är aktiverad) Marginalprocenten, som beräknas med ([!UICONTROL Gross Spend] - [!UICONTROL Net Spend]) / [!UICONTROL Gross Spend]. |
...
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Net vCPM] | Genomsnittlig nettokostnad per 1 000 visningar, beräknad med [!UICONTROL Net Spend] / [!UICONTROL Viewable Impressions] x 1000. |
...
| [!UICONTROL Metric] | [!UICONTROL Viewability] | [!UICONTROL Measurable Rate (%)] | Procentandel av visningar som kunde mätas för att se bilden, beräknat som [!UICONTROL Measurable Impressions] x 1000 / [!UICONTROL Impressions]. |
...
| [!UICONTROL Metric] | [!UICONTROL Viewability] | [!UICONTROL Viewability Rate (%)] | Procentandel av visningar av alla mätbara exponeringar, beräknat som [!UICONTROL Viewable Impressions] / [!UICONTROL Measurable Impressions]. |
...
| [!UICONTROL Custom Goals] | [Grupperad av annonsören i rapportinställningarna] | [Advertiser-specifikt anpassat mål] | Den viktade summan av alla konverteringar som ingår i den angivna [anpassat mål](/help/dsp/optimization/custom-goal-about.md). |
